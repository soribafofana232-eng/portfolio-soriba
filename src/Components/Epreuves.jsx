...
export default function Epreuves() {
  ...
  return (
    <section className="px-20 py-16 bg-gray-50 min-h-screen">
      {/* --- Titre principal --- */}
      <h1 className="text-4xl font-bold text-blue-900 mb-10 border-b-4 border-blue-600 inline-block">
        Épreuves
      </h1>
          ...
          {activeTab === "E5" && (
            ...
            >
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                ...
                informatique, la réponse aux incidents et le développement de la
                présence en ligne.
              </p>
