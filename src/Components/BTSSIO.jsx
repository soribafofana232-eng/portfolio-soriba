      ...
      <div className="max-w-6xl mx-auto mt-12 grid md:grid-cols-2 gap-8">
        <div className="bg-white shadow-md border-l-4 border-blue-600 rounded-2xl p-8">
          <h3 className="text-xl font-semibold text-blue-700 mb-2 flex items-center gap-2">
            💻 SISR <span className="text-gray-500 text-sm">Option suivie</span>
          </h3>
          <p className="text-gray-700 leading-relaxed">
            <strong>Solutions d'Infrastructure, Systèmes et Réseaux (SISR)</strong> forme aux métiers liés à la conception et à la maintenance d'infrastructures réseaux, avec un focus sur la cybersécurité.
          </p>
        ...
        <div className="bg-white shadow-md border-l-4 border-gray-400 rounded-2xl p-8">
          <h3 className="text-xl font-semibold text-gray-700 mb-2 flex items-center gap-2">
            ⚙️ SLAM <span className="text-gray-500 text-sm">Option alternative</span>
          </h3>
          <p className="text-gray-700 leading-relaxed">
            <strong>Solutions Logicielles et Applications Métiers (SLAM)</strong> prépare aux métiers du développement d’applications, avec des compétences en programmation et bases de données.
          </p>
          <ul className="list-disc list-inside text-gray-700 leading-relaxed mt-3">
            <li>Développement</li>
